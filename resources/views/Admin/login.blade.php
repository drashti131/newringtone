...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<link href="{{asset('public/Assets')}}/css/pages/login/login-2.css" rel="stylesheet" type="text/css" />
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
				...
				<div class="login-aside order-2 order-lg-1 d-flex flex-row-auto position-relative overflow-hidden">
					...
					<div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
						...
						<a href="#" class="text-center pt-2">
							<img src="{{asset('public/Assets')}}/media/logos/logo.png" class="max-h-75px" alt="" />
						</a>
						<!--end::Logo-->
						<!--begin::Aside body-->
						...
						<div class="d-flex flex-column-fluid flex-column flex-center">
							...
							<div class="login-form login-signin py-11">
								<!--begin::Form-->
								<form class="form" action="{{url('authcheck')}}" method="post">
                                    @csrf
									<!--begin::Title-->
                                    ...
                                    <div class="alert alert-{{ Session::get('message')['type'] }} alert-block">
									...
									<div class="form-group">
										...
										<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="text" name="username" autocomplete="off" value="{{old('username')}}"/>
                                        @error('username')
                                            <span class="errorred">{{$message}}</span>
                                        @enderror
									</div>
									<!--end::Form group-->
									<!--begin::Form group-->
				...
				<div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-color: #B1DCED;">
					...
					<!--end::Title-->
					<!--begin::Image-->
					<div class="content-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center" style="background-image: url({{asset('public/Assets')}}/media/svg/illustrations/login-visual-2.svg);"></div>
					<!--end::Image-->
				</div>
				<!--end::Content-->
			</div>
